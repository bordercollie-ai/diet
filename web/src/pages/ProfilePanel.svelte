  ...
  <Card.Root class="overflow-visible">
    ...
    <Card.Content>
      <form class="grid gap-4" onsubmit={onSave}>
        ...
        <div class="grid grid-cols-2 gap-4">
          <div class="grid gap-2">
            <Label for="profile-target-weight">{t('targetWeightKg')}</Label>
            <Input
